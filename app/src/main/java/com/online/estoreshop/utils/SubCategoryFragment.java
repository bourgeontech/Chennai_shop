...
public class SubCategoryFragment extends BottomSheetDialogFragment implements ClickedItem {

    String msg;
    SelectCategoryAdapter adapter;
    ArrayList<CategoryDomain> productList = new ArrayList<>();

    public SubCategoryFragment(ArrayList<CategoryDomain> productList) {
    ...
    public void setOptionListener2(SubCategoryFragment.OptionListener2 optionListener) {
    ...
    public void clicked(String type, Object object) {
        ...
        if (type.equals("click")) {
            dismiss();
            optionListener.optionSelected2(productDomain);
        }
    }

    public interface OptionListener2 {
        void optionSelected2(CategoryDomain categoryDomain);
    }
